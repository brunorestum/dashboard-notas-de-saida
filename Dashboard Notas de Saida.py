# -*- coding: utf-8 -*-
"""
Dashboard ICMS adaptado para Streamlit Cloud
"""
...
# =========================================
# Upload do Excel pelo usuário
# =========================================
uploaded_file = st.file_uploader("Escolha o arquivo Excel (comparacao-saidas.xlsx)", type=["xlsx"])
if uploaded_file is not None:
    comparacao_df = pd.read_excel(uploaded_file)
    ...
    st.warning("⚠️ Por favor, faça upload do arquivo Excel para visualizar o Dashboard.")
